    ...
    private void addMarkersToMap(int tabPosition) {
        ...
        if (tabPosition == 0) {
            for (String key : receivedMap.keySet()) {
                ...
                if (latLngList == null || nameList == null || latLngList.isEmpty() || nameList.isEmpty()) {
                    continue;
                }
                ...
                if (latLngList.size() > 1) {
                    ...
                    // Accumulate coordinates for the middle point
        ...
        // Add middle point marker after all markers/routes are set
        addMiddlePointMarker(sumLat, sumLng, count);
    }

    private void addMiddlePointMarker(double sumLat, double sumLng, int count) {
        if (count > 0) {
